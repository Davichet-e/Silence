...
from dal.database.db_connection import conn, oracle_engine
from dal.transaction import get_g


def query(q: str, params: Optional[Union[tuple, list, dict]] = None) -> List[dict]:
    ...
    try:
        ...
        return [dict(zip(columns, data)) for data in all_data]
...
def execute(q: str, params: Optional[Union[tuple]] = None) -> int:
    ...
    try:
        ...
        oid_name: str = query(oid_query)[0]["COLUMN_NAME"]
